...
Locates the _cc_completer binary installed by maturin.
"""
...
def find_completer_binary() -> Path:
    """Locate the _cc_completer binary.
    ...
    name = "_cc_completer.exe" if _ON_WIN else "_cc_completer"
    ...
    for candidate in candidates:
        ...
        if resolved.is_file():
            return resolved
    msg = "_cc_completer binary not found"
